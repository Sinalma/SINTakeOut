...
@interface SINLifeViewController ()
...
@implementation SINLifeViewController
#pragma mark - 启动入口
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)loadFirstData
{
    NSDictionary *dict = @{@"lat":@"2557447.603092",@"lng":@"12617387.753393",@"category_id":@"1484558763740833118",@"city_id":@"187"};
...
- (void)loadData:(LoadDataType)loadDataType
{
    ...
    NSDictionary *dict = @{@"lat":@"2557447.603092",@"lng":@"12617387.753393",@"category_id":@"1484558763740833118",@"city_id":@"187",@"history_member":strNum};
